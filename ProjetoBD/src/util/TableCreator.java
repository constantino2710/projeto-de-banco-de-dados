...
public class TableCreator {
    ...
    public void createRolePapelUsuario(int idUsuario) {
        ...
        // Corrigido: trocar webdriver_user por root
        String grantRoleToUserSQL = "GRANT PapelUsuario TO 'root'@'localhost'";
        executeSQL(grantRoleToUserSQL, "Role concedida ao usuário 'root'.");
    }
    ...
    public void createRolePapelInst() {
        ...
        executeSQL(grantSelectInst, "Permissões de visualização da instituição.");

        String grantSelectUsuario = "GRANT SELECT ON usuario TO PapelInstituicao";
        executeSQL(grantSelectUsuario, "Permissões de visualização dos usuários.");

        String grantSelectArq = "GRANT SELECT ON usuario TO PapelInstituicao"; // Este pode ser arquivo, revise se
                                                                               // necessário
        executeSQL(grantSelectArq, "Permissões de visualização dos arquivos.");

        // Corrigido: trocar webdriver_user por root
        String grantRoleToUserSQL = "GRANT PapelInstituicao TO 'root'@'localhost'";
        executeSQL(grantRoleToUserSQL, "Role concedida ao usuário 'root'.");
    }
    ...
    public void createRolePapelAdm() {
        ...
        String grantPermission = "GRANT SELECT, INSERT, UPDATE, DELETE ON projetobd.* TO PapelAdm"; // nome do banco
                                                                                                    // alterável
        executeSQL(grantPermission,
                "Conceder permissões de leitura, inserção, atualização e exclusão em todas as tabelas do banco de dados.");

        String grantRoleToUserSQL = "GRANT PapelAdm TO 'root'@'localhost'";
        executeSQL(grantRoleToUserSQL, "Role concedida ao usuário 'root'.");
    }
